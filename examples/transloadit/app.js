...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e3.byteLength}`), e3.tiff && await e3.ensureChunk(this.ifd0Offset, o2(this.options));
  ...
  var require_lib9 = __commonJS({
    "../packages/@uppy/tus/lib/index.js"(exports, module) {
      "use strict";
      var tus = require_browser();
      var _companionClient = require_lib8();
  ...
  var require_lib10 = __commonJS({
    "../packages/@uppy/transloadit/lib/index.js"(exports, module) {
      ...
      var Transloadit2 = class extends BasePlugin {
        constructor(uppy, opts) {
          var _this;
          super(uppy, opts);
          _this = this;
      ...
      Transloadit2.VERSION = packageJson.version;
      module.exports = Transloadit2;
      Transloadit2.COMPANION = COMPANION2;
      Transloadit2.ALLOWED_COMPANION_PATTERN = ALLOWED_COMPANION_PATTERN;
    }
  });
  ...
  var require_Breadcrumbs = __commonJS({
    "../packages/@uppy/provider-views/lib/Breadcrumbs.js"(exports, module) {
      ...
      module.exports = (props) => {
        ...
        }, breadcrumbsIcon), directories.map((directory, i2) => (0, _preact.h)(Breadcrumb, {
          key: directory.id,
      ...
      var ProviderView = class extends View {
        ...
        async handleAuth() {
          ...
          const handleToken = (e2) => {
            if (!isOriginAllowed(e2.origin, this.plugin.opts.companionAllowedHosts) || e2.source !== authWindow) {
  ...
  var require_Instagram = __commonJS({
    "../packages/@uppy/instagram/lib/Instagram.js"(exports, module) {
      ...
      var _core = require_lib2();
      var _companionClient = require_lib8();
      var _providerViews = require_lib11();
      var packageJson = {
        "version": "2.1.1"
      };
